    ...
    while (1) {
        ...
        switch (choiceNum) {
            ...
            case 4:
                ...
                char word[wordSize];
                gets(word);//read the entered word
                gets(word);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
table rehashedTable(table hashTable1, int tableSize, int *new) {
    int newTableSize = hashTableSize(tableSize * 2); // First prime greater then the double of size
    *new = newTableSize;
    int j = 1;
...
table rehasedSecondTable(table table1, int tableSize, int *new) {
    ...
    *new = newSize;
    int j = 1;
    table newTable = (table) malloc(sizeof(struct hashTable) * newSize);
